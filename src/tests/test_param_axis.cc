...
CASE ("ocean1") {
    ...
    std::vector<std::string> axis = {"145.128", "164.128", "175.128", "148.128", "145.151", "164.151", "175.151", "148.151"};
...
CASE("MARS-794") {
    ...
    SECTION("some params") {
        ...
        std::vector<std::string> expect = {"148.128","145.128","164.128","175.128","148.151","145.151","164.151","175.151"};
        test_param_axis(user, axis, expect, false);
    }
}
