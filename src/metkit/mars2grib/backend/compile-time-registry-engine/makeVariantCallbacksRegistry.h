...
makeEntryVariantCallbacks(ValueList<Variants...>) {
    return {{
        Entry::template variantCallbacks<
            Capability,
            Variants,
            MarsDict_t,
            ParDict_t,
...
> {
    static constexpr std::array<
        VariantCallback<MarsDict_t, ParDict_t, OptDict_t, OutDict_t>,
        0
    >
    value() {
        return {};
...
constexpr auto makeVariantCallbacksRegistry() {
    return detail::BuildVariantCallbacks<
        EntriesList,
        Capability,
        MarsDict_t,
        ParDict_t,
