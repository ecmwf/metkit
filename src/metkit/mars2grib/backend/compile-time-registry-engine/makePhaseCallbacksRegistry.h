...
using PhaseRow =
    std::array<Fn<MarsDict_t, ParDict_t, OptDict_t, OutDict_t>, NUM_SECTIONS>;
...
template <class MarsDict_t, class ParDict_t, class OptDict_t, class OutDict_t>
using PhasePlane =
    std::array<PhaseRow<MarsDict_t, ParDict_t, OptDict_t, OutDict_t>, NUM_STAGES>;
...
template <
    ...
    std::size_t... Secs
>
constexpr PhaseRow<MarsDict_t, ParDict_t, OptDict_t, OutDict_t>
makePhaseRow(std::index_sequence<Secs...>) {
    return {{
        Entry::template phaseCallbacks<
            Capability,
            Stage,
            Secs,
            Variant,
...
template <
    ...
    std::size_t... Stages
>
constexpr PhasePlane<MarsDict_t, ParDict_t, OptDict_t, OutDict_t>
makePhasePlane(std::index_sequence<Stages...>) {
    return {{
        // For every stage in Stages..., build a full row of sections
        makePhaseRow<Entry, Capability, Stages, Variant,
...
>
constexpr std::array<
    PhasePlane<MarsDict_t, ParDict_t, OptDict_t, OutDict_t>,
    sizeof...(Variants)
>
...
constexpr auto makeEntryPhaseCallbacks() {
    return makeEntryPhaseCallbacks<
        Entry,
        Capability,
        MarsDict_t,
        ParDict_t,
...
constexpr auto makePhaseCallbacksRegistry() {
    return detail::BuildPhaseCallbacks<
        EntriesList,
        Capability,
        MarsDict_t,
        ParDict_t,
