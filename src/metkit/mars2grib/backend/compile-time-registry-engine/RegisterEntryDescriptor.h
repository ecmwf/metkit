...
struct RegisterEntryDescriptor {
     ...
     */
    template <std::size_t Capability, std::size_t Stage, std::size_t Section, VariantEnum Variant, class MarsDict_t, class ParDict_t,
     ...
     */
    template <std::size_t Capability, VariantEnum Variant, class MarsDict_t, class ParDict_t,
              class OptDict_t, class OutDict_t>
