...
/// @brief Resolve the mandatory `numberOfFourierCoefficients` misc value.
#pragma once
#include "metkit/mars2grib/backend/misc-defaults/detail/Scalar.h"
namespace metkit::mars2grib::backend::misc_defaults::rules {
struct NumberOfFourierCoefficients {
    using value_type = long;
    static constexpr std::string_view name{"numberOfFourierCoefficients"};
