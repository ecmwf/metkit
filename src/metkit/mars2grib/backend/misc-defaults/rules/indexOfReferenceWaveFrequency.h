 ...
 */
/// @file indexOfReferenceWaveFrequency.h
/// @brief Resolve the wave-frequency reconstruction reference index.
#pragma once
#include "metkit/mars2grib/backend/misc-defaults/detail/Scalar.h"
namespace metkit::mars2grib::backend::misc_defaults::rules {
struct IndexOfReferenceWaveFrequency {
    using value_type = long;
    static constexpr std::string_view name{"indexOfReferenceWaveFrequency"};
