 ...
 */
/// @file scaleFactorOfWaveFrequencies.h
/// @brief Resolve the wave-frequency scale factor with its default of 6.
#pragma once
#include "metkit/mars2grib/backend/misc-defaults/detail/Scalar.h"
namespace metkit::mars2grib::backend::misc_defaults::rules {
struct ScaleFactorOfWaveFrequencies {
    using value_type = long;
    static constexpr std::string_view name{"scaleFactorOfWaveFrequencies"};
