...
/// @brief Resolve the mandatory central-wave-number scaled value.
#pragma once
#include "metkit/mars2grib/backend/misc-defaults/detail/Scalar.h"
namespace metkit::mars2grib::backend::misc_defaults::rules {
struct ScaledValueOfCentralWaveNumber {
    using value_type = long;
    static constexpr std::string_view name{"scaledValueOfCentralWaveNumber"};
