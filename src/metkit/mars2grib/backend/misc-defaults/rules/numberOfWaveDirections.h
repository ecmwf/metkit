 ...
 */
/// @file numberOfWaveDirections.h
/// @brief Resolve a wave-direction reconstruction count.
#pragma once
#include "metkit/mars2grib/backend/misc-defaults/detail/Scalar.h"
namespace metkit::mars2grib::backend::misc_defaults::rules {
struct NumberOfWaveDirections {
    using value_type = long;
    static constexpr std::string_view name{"numberOfWaveDirections"};
