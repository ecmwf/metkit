...
/// @brief Resolve the mandatory central-wave-number scale factor.
#pragma once
#include "metkit/mars2grib/backend/misc-defaults/detail/Scalar.h"
namespace metkit::mars2grib::backend::misc_defaults::rules {
struct ScaleFactorOfCentralWaveNumber {
    using value_type = long;
    static constexpr std::string_view name{"scaleFactorOfCentralWaveNumber"};
