...
/// @brief Resolve an optional generating-process identifier.
#pragma once
#include "metkit/mars2grib/backend/misc-defaults/detail/Scalar.h"
namespace metkit::mars2grib::backend::misc_defaults::rules {
struct GeneratingProcessIdentifier {
    using value_type = long;
    static constexpr std::string_view name{"generatingProcessIdentifier"};
