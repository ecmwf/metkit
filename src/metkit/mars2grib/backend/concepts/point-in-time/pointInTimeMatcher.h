...
std::size_t pointInTimeMatcher(const MarsDict_t& mars, const OptDict_t& opt) {
    ...
    if (matchAny(param, range(1, 3), 10, range(15, 18), range(21, 23), range(26, 43), 53, 54, 59, 60, 66, 67,
                 ...
                 range(228217, 228221), range(228231, 228237), 260004, 260005, 260015, 260038, 260048, 260109, 260121,
                 260123, 260132, 260199, 260242, 260255, 260260, 260289, 260290, 260292, 260293, 260360, 260509, 260688,
                 261001, 261002, range(261014, 261016), 261018, 261023, 262000, 262024, 262100, 262104, 262118, 262124,
                 262139, 262140, 262144)) {
