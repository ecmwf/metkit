 ...
 */
template <class ConceptInfo, auto Variant, class MarsDict_t, class ParDict_t, class OptDict_t, class OutDict_t,
          std::size_t Stage, std::size_t... Secs>
constexpr std::array<Fn<MarsDict_t, ParDict_t, OptDict_t, OutDict_t>, sizeof...(Secs)> makeStageRow(
...
template <class ConceptInfo, auto Variant, class MarsDict_t, class ParDict_t, class OptDict_t, class OutDict_t,
          std::size_t... Stages>
constexpr std::array<std::array<Fn<MarsDict_t, ParDict_t, OptDict_t, OutDict_t>, NUM_SECTIONS>, sizeof...(Stages)>
makeTable(std::index_sequence<Stages...>) {
    return {{makeStageRow<ConceptInfo, Variant, MarsDict_t, ParDict_t, OptDict_t, OutDict_t, Stages>(
...
constexpr auto makeConceptTable() {
    return makeTable<ConceptInfo, Variant, MarsDict_t, ParDict_t, OptDict_t, OutDict_t>(
 ...
 */
template <class Registry, class ConceptInfo, class MarsDict_t, class ParDict_t, class OptDict_t, class OutDict_t>
struct RegisterVariantHelper {
    template <auto Variant>
    struct Func {
        static void apply(Registry& registry) {
            auto table = makeConceptTable<ConceptInfo, Variant, MarsDict_t, ParDict_t, OptDict_t, OutDict_t>();
 ...
 */
template <class ConceptInfo, class VariantList, class MarsDict_t, class ParDict_t, class OptDict_t, class OutDict_t>
struct RegisterVariants;


template <class ConceptInfo, auto... Values, class MarsDict_t, class ParDict_t, class OptDict_t, class OutDict_t>
struct RegisterVariants<ConceptInfo, ValueList<Values...>, MarsDict_t, ParDict_t, OptDict_t, OutDict_t> {
    template <class Registry>
    static void run(Registry& registry) {
        using Helper = RegisterVariantHelper<Registry, ConceptInfo, MarsDict_t, ParDict_t, OptDict_t, OutDict_t>;
