...
std::size_t compositionMatcher(const MarsDict_t& mars, const OptDict_t& opt) {
    ...
    if (hasWavelength) {
        ...
        if (matchAny(param, 401000)) {
            ...
            if (matchAny(chem, 2, 3, range(5, 24), range(26, 30), range(32, 50), 52, 53, range(55, 58), range(63, 80), 82, 83, 85, 86, range(99, 101), 107, 112, 159, 161, 169, range(173, 178), range(186, 204), 222, range(224, 231), 233, 311, 359, 404, 917)) {
            ...
            if (matchAny(chem, range(2, 24), range(26, 30), range(32, 50), 52, 53, range(55, 59), range(63, 80), 82, 83, 85, 86, range(99, 101), 107, 112, 118, 159, 161, 169, range(173, 178), range(186, 204), 222, range(224, 230), 233, 236, 311)) {
                return static_cast<std::size_t>(CompositionType::Chem);
            }
            ...
            if (matchAny(chem, 2, 5, 9, 10, 12, 16, 18, 19, 42, range(45, 48), 52, 99, 100, 129, 224, 226, 233, 311, 933, 934)) {
