...
std::size_t statisticsMatcher(const MarsDict_t& mars, const OptDict_t& opt) {
    try {
        ...
        if (matchAny(param, range(141101, 141105), 141208, 141209, 141215, 141216, 141220, 141229, 141231, 141232, 141233,
                     ...
                     235098, 235100, 235108, 235117, range(235129, 235138), 235151, 235152, 235155, 235157, 235159, 235165,
                     235166, 235168, 235189, 235203, 235246, 235263, 235269, 235283, 235287, 235288, 235290, 235305,
                     235309, 235320, 235322, 235326, 235339, 235383, 263024, 263107)) {
        ...
        if (matchAny(param, 49, 121, 123, 201, range(143101, 143105), 143208, 143209, 143215, 143216, 143220, 143229,
                     143231, 143232, 143233, 143245, 228026, 228028, 228035, 228036, 228222, 228224, 228226, 237013, 237041,
                     237042, 237055, 237077, 237078, 237079, 237080, 237083, 237084, 237087, 237088, 237090, 237091, 237093,
                     ...
                     237320, 237321, 237322, 237326, 265024)) {
        ...
        if (matchAny(param, 122, 202, range(144101, 144105), 144208, 144209, 144215, 144216, 144220, 144229, 144231, 144232,
                     144233, 144245, 228027, 228223, 228225, 228227, 238013, 238041, 238042, 238055, 238077, 238078, 238079,
                     238080, 238083, 238084, 238087, 238088, 238090, 238091, 238093, 238094, 238097, 238108, 238117, 238131,
                     238132, 238134, 238137, 238151, 238159, range(238165, 238168), 238203, 238207, 238263, 238287,
                     238288, 238290, 238305, 238309, 238320, 238322, 238326, 266024, 131070)) {
        ...
        if (matchAny(param, range(145101, 145105), 145208, 145209, 145215, 145216, 145220, 145229, 145231, 145232, 145233,
                     145245, 239041, 239042, 239077, 239078, 239079, 239080, 239083, 239084, 239087, 239088, 239090, 239091,
                     239093, 239094, 239097, 239108, 239117, 239131, 239132, 239134, 239137, 239151, 239159,
                     range(239165, 239168), 239203, 239207, 239263, 239287, 239288, 239290, 239305, 239309, 239320, 239322,
                     239326, 267024)) {
