...
///
/// @file originMatcher.h
/// @brief Entry-level matcher for the GRIB `origin` concept.
///
/// This header defines the runtime matcher used by the concept registry to
/// activate the default originating-centre concept variant.
///
...
///
/// @brief Match the `origin` concept variant.
///
/// The origin concept is always active and resolves to `OriginType::Default`.
///
...
///
/// @return Local variant index for `OriginType::Default`.
///
