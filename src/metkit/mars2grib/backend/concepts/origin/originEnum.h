...
/**
 * @file originEnum.h
 * @brief Definition of the `origin` concept variants and compile-time metadata.
 *
 * This header defines the **static description** of the GRIB `origin` concept
 * used by the mars2grib backend. It contains:
 *
 * - the canonical concept name (`originName`)
 * - the enumeration of supported origin variants (`OriginType`)
 * - a compile-time typelist of all variants (`OriginList`)
 ...
 * `origin.h` / `originOp` implementation.
 *
 ...
 * - to associate variants and capabilities with the `origin` concept
 *
...
/**
 * @brief Enumeration of all supported `origin` concept variants.
 *
 * Each enumerator represents a specific origin or provenance
 ...
 * introduced in the future as the origin concept evolves.
 *
 * @warning
...
/**
 * @brief Compile-time list of all `origin` concept variants.
 *
...
/**
 * @brief Compile-time mapping from `OriginType` to human-readable name.
 *
 * This function returns the canonical string identifier associated
 * with a given origin variant.
 *
