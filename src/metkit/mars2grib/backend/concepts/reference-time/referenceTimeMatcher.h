...
///
/// @file referenceTimeMatcher.h
/// @brief Entry-level matcher for the GRIB `referenceTime` concept.
///
/// This header defines the runtime matcher used by the concept registry to
/// choose between standard and reforecast reference-time handling.
///
...
///
/// @brief Match the `referenceTime` concept variant.
///
/// The matcher selects `ReferenceTimeType::Reforecast` when `hdate` is present
/// in the MARS request, and `ReferenceTimeType::Standard` otherwise.
///
...
///
/// @return Local variant index for the selected reference-time variant.
///
