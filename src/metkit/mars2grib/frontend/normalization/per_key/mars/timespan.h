...
///
/// @brief Individual sanitization check for the GRIB key: timespan.
///
template <typename MarsDict_t, typename Cntx_t>
void sanitise_timespan_or_throw(const MarsDict_t& in, MarsDict_t& out, const eckit::Value& language, Cntx_t& cntx) {
