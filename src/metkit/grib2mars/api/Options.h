...
///
/// @file Options.h
/// @brief Configuration options for the Grib2Mars conversion API.
///
/// This header defines the public configuration structure used to control the
/// behaviour of the Grib2Mars API error boundary.
///
...
///
/// @brief API error-handling options for Grib2Mars.
///
...
///   API used for other Grib2Mars dictionaries;
