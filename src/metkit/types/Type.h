...
public: // methods
    ...
    virtual std::string tidy(const MarsRequestContext& ctx, const std::string& value) const;

    virtual void setDefaults(MarsRequest& request);
    virtual void setDefaults(const std::vector<std::string>& defaults);
    virtual void check(const MarsRequestContext& ctx, const std::vector<std::string>& values) const;
    virtual void clearDefaults();
    virtual void reset();

    virtual void pass2(const MarsRequestContext& ctx, MarsRequest& request);
    virtual void finalise(const MarsRequestContext& ctx, MarsRequest& request);
