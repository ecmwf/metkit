...
public:
    ...
    virtual eckit::Value eval(U& p) const override { return T()(cond_->eval(p)); }
};
...
public:
    ...
    eckit::Value eval(U& task) const override;
};
...
public:
    ...
    virtual eckit::Value eval(T&) const override { return eckit::Value(str_); }
};
...
public:
    ...
    virtual eckit::Value eval(T&) const override { return eckit::Value(value_); }
};
...
public:
    ...
    virtual eckit::Value eval(T&) const override;
};
