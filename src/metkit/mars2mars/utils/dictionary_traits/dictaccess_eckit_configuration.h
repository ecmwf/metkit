...
// GET_OR_THROW
// ==============================================================
#define M2M_DEFINE_LOCALCONFIG_DICT_GET_OR_THROW(CTYPE, ISFUNC, GETFUNC)                                               \
    template <>                                                                                                        \
    struct DictGetOrThrow<eckit::LocalConfiguration, CTYPE> {                                                          \
        ...
        static CTYPE get_or_throw(const eckit::LocalConfiguration& cfg, std::string_view key) noexcept(false) {        \
            ...
            try {                                                                                                      \
                /* Check key exists */                                                                                 \
                if (!cfg.has(k)) {                                                                                     \
                    throw exceptions::Mars2marsDictException("Missing key `"s + k + "` in dictionary type `"s +        \
...
// GET_OPT
// ==============================================================
#define M2M_DEFINE_LOCALCONFIG_DICT_GET_OPT(CTYPE, ISFUNC, GETFUNC)                 \
    template <>                                                                     \
...
// SET_OR_THROW
// ==============================================================
#define M2M_DEFINE_LOCALCONFIG_DICT_SET_OR_IGNORE(CTYPE, SETFUNC)                       \
    template <>                                                                         \
...
// SET_OR_IGNORE
// ==============================================================
#define M2M_DEFINE_LOCALCONFIG_DICT_SET_OR_THROW(CTYPE, SETFUNC)                                               \
    template <>                                                                                                \
...
// bool
M2M_DEFINE_LOCALCONFIG_DICT_GET_OR_THROW(bool, isBoolean, getBool)
M2M_DEFINE_LOCALCONFIG_DICT_GET_OPT(bool, isBoolean, getBool)
M2M_DEFINE_LOCALCONFIG_DICT_SET_OR_THROW(bool, set)
M2M_DEFINE_LOCALCONFIG_DICT_SET_OR_IGNORE(bool, set)

// int
M2M_DEFINE_LOCALCONFIG_DICT_GET_OR_THROW(int, isIntegral, getInt)
M2M_DEFINE_LOCALCONFIG_DICT_GET_OPT(int, isIntegral, getInt)
M2M_DEFINE_LOCALCONFIG_DICT_SET_OR_THROW(int, set)
M2M_DEFINE_LOCALCONFIG_DICT_SET_OR_IGNORE(int, set)

// long
M2M_DEFINE_LOCALCONFIG_DICT_GET_OR_THROW(long, isIntegral, getLong)
M2M_DEFINE_LOCALCONFIG_DICT_GET_OPT(long, isIntegral, getLong)
M2M_DEFINE_LOCALCONFIG_DICT_SET_OR_THROW(long, set)
M2M_DEFINE_LOCALCONFIG_DICT_SET_OR_IGNORE(long, set)

// float
M2M_DEFINE_LOCALCONFIG_DICT_GET_OR_THROW(float, isFloatingPoint, getFloat)
M2M_DEFINE_LOCALCONFIG_DICT_GET_OPT(float, isFloatingPoint, getFloat)
M2M_DEFINE_LOCALCONFIG_DICT_SET_OR_THROW(float, set)
M2M_DEFINE_LOCALCONFIG_DICT_SET_OR_IGNORE(float, set)

// double
M2M_DEFINE_LOCALCONFIG_DICT_GET_OR_THROW(double, isFloatingPoint, getDouble)
M2M_DEFINE_LOCALCONFIG_DICT_GET_OPT(double, isFloatingPoint, getDouble)
M2M_DEFINE_LOCALCONFIG_DICT_SET_OR_THROW(double, set)
M2M_DEFINE_LOCALCONFIG_DICT_SET_OR_IGNORE(double, set)

// std::string
M2M_DEFINE_LOCALCONFIG_DICT_GET_OR_THROW(std::string, isString, getString)
M2M_DEFINE_LOCALCONFIG_DICT_GET_OPT(std::string, isString, getString)
M2M_DEFINE_LOCALCONFIG_DICT_SET_OR_THROW(std::string, set)
M2M_DEFINE_LOCALCONFIG_DICT_SET_OR_IGNORE(std::string, set)

// eckit::LocalConfiguration (sub-configuration)
M2M_DEFINE_LOCALCONFIG_DICT_GET_OR_THROW(eckit::LocalConfiguration, isSubConfiguration, getSubConfiguration)
M2M_DEFINE_LOCALCONFIG_DICT_GET_OPT(eckit::LocalConfiguration, isSubConfiguration, getSubConfiguration)
M2M_DEFINE_LOCALCONFIG_DICT_SET_OR_THROW(eckit::LocalConfiguration, set)
M2M_DEFINE_LOCALCONFIG_DICT_SET_OR_IGNORE(eckit::LocalConfiguration, set)
...
// std::vector<int>
M2M_DEFINE_LOCALCONFIG_DICT_GET_OR_THROW(std::vector<int>, isIntegralList, getIntVector)
M2M_DEFINE_LOCALCONFIG_DICT_GET_OPT(std::vector<int>, isIntegralList, getIntVector)
M2M_DEFINE_LOCALCONFIG_DICT_SET_OR_THROW(std::vector<int>, set)
M2M_DEFINE_LOCALCONFIG_DICT_SET_OR_IGNORE(std::vector<int>, set)

// std::vector<long>
M2M_DEFINE_LOCALCONFIG_DICT_GET_OR_THROW(std::vector<long>, isIntegralList, getLongVector)
M2M_DEFINE_LOCALCONFIG_DICT_GET_OPT(std::vector<long>, isIntegralList, getLongVector)
M2M_DEFINE_LOCALCONFIG_DICT_SET_OR_THROW(std::vector<long>, set)
M2M_DEFINE_LOCALCONFIG_DICT_SET_OR_IGNORE(std::vector<long>, set)

// std::vector<float>
M2M_DEFINE_LOCALCONFIG_DICT_GET_OR_THROW(std::vector<float>, isFloatingPointList, getFloatVector)
M2M_DEFINE_LOCALCONFIG_DICT_GET_OPT(std::vector<float>, isFloatingPointList, getFloatVector)
M2M_DEFINE_LOCALCONFIG_DICT_SET_OR_THROW(std::vector<float>, set)
M2M_DEFINE_LOCALCONFIG_DICT_SET_OR_IGNORE(std::vector<float>, set)

// std::vector<double>
M2M_DEFINE_LOCALCONFIG_DICT_GET_OR_THROW(std::vector<double>, isFloatingPointList, getDoubleVector)
M2M_DEFINE_LOCALCONFIG_DICT_GET_OPT(std::vector<double>, isFloatingPointList, getDoubleVector)
M2M_DEFINE_LOCALCONFIG_DICT_SET_OR_THROW(std::vector<double>, set)
M2M_DEFINE_LOCALCONFIG_DICT_SET_OR_IGNORE(std::vector<double>, set)

// std::vector<std::string>
M2M_DEFINE_LOCALCONFIG_DICT_GET_OR_THROW(std::vector<std::string>, isStringList, getStringVector)
M2M_DEFINE_LOCALCONFIG_DICT_GET_OPT(std::vector<std::string>, isStringList, getStringVector)
M2M_DEFINE_LOCALCONFIG_DICT_SET_OR_THROW(std::vector<std::string>, set)
M2M_DEFINE_LOCALCONFIG_DICT_SET_OR_IGNORE(std::vector<std::string>, set)

// std::vector<eckit::LocalConfiguration>
M2M_DEFINE_LOCALCONFIG_DICT_GET_OR_THROW(std::vector<eckit::LocalConfiguration>, isSubConfigurationList,
                                         getSubConfigurations)
M2M_DEFINE_LOCALCONFIG_DICT_GET_OPT(std::vector<eckit::LocalConfiguration>, isSubConfigurationList,
                                    getSubConfigurations)
M2M_DEFINE_LOCALCONFIG_DICT_SET_OR_THROW(std::vector<eckit::LocalConfiguration>, set)
M2M_DEFINE_LOCALCONFIG_DICT_SET_OR_IGNORE(std::vector<eckit::LocalConfiguration>, set)
