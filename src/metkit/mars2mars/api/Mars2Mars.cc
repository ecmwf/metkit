...
Mars2Mars::Mars2Mars() : opts_{checkEnvironment({})} {}

Mars2Mars::Mars2Mars(const Options& opts) : opts_{checkEnvironment(opts)} {}

Mars2Mars::Mars2Mars(const eckit::LocalConfiguration& opts) : opts_{checkEnvironment(detail::readOptions(opts))} {}

Mars2Mars::Mars2Mars(OptionList opts) : opts_{checkEnvironment(detail::readOptions(opts))} {}
