...
- :doc:`api` — the Pythonic layer: :class:`~pymetkit.MarsRequest`
  (a verb plus a :data:`~pymetkit.MarsSelection`),
  :func:`~pymetkit.parse_mars_request`, and
  :func:`~pymetkit.expand`.
