...
int main() {
...

    {
        ...
        for (std::size_t i = 0; i < payload0.size(); ++i) {
            ...
            std::cout << "Section0 :: " << i << " - " << expectedTemplateNumber << " - "
                      << sectionLayoutData.templateNumber << std::endl;
...

    {
        ...
        for (std::size_t i = 0; i < payload1.size(); ++i) {
            ...
            std::cout << "Section1 :: " << i << " - " << expectedTemplateNumber << " - "
                      << sectionLayoutData.templateNumber << std::endl;
            assert(expectedTemplateNumber == sectionLayoutData.templateNumber);
        }
    }

    {
        ...
        for (std::size_t i = 0; i < payload2.size(); ++i) {
            ...
            std::cout << "Section2 :: " << i << " - " << expectedTemplateNumber << " - "
                      << sectionLayoutData.templateNumber << std::endl;
            assert(expectedTemplateNumber == sectionLayoutData.templateNumber);
        }
    }

    {
        ...
        for (std::size_t i = 0; i < payload3.size(); ++i) {
            ...
            std::cout << "Section3 :: " << i << " - " << expectedTemplateNumber << " - "
                      << sectionLayoutData.templateNumber << std::endl;
            assert(expectedTemplateNumber == sectionLayoutData.templateNumber);
        }
    }

    {
        ...
        for (std::size_t i = 0; i < payload4.size(); ++i) {
            ...
            std::cout << "Section4 :: " << i << " - " << expectedTemplateNumber << " - "
                      << sectionLayoutData.templateNumber << std::endl;
            assert(expectedTemplateNumber == sectionLayoutData.templateNumber);
        }
    }

    {
        ...
        for (std::size_t i = 0; i < payload5.size(); ++i) {
            ...
            std::cout << "Section5 :: " << i << " - " << expectedTemplateNumber << " - "
                      << sectionLayoutData.templateNumber << std::endl;
            assert(expectedTemplateNumber == sectionLayoutData.templateNumber);
        }
    }
