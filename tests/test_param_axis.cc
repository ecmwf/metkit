...
CASE("MARS-794 - GRIB1 and GRIB2 in axis") {
  ...
  SECTION("by paramId all") {
      std::vector<std::string> user = { "151148","151145","151164","151175","128148","128145","128164","128175"};
      std::vector<std::string> expect = {"148.151","145.151","164.151","175.151","148.128","145.128","164.128","175.128"};
      test_param_axis(user, axis, expect, false);
  }
  ...
  SECTION("by param.table all") {
      std::vector<std::string> user = { "148.151","145.151","164.151","175.151","148.128","145.128","164.128","175.128"};
      std::vector<std::string> expect = {"148.151","145.151","164.151","175.151","148.128","145.128","164.128","175.128"};
      test_param_axis(user, axis, expect, false);
  }
}
